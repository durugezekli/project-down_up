...
class MyApp():
    def __init__(self):
        self.section_colors = {"Alfabe": ft.colors.RED, "Şekiller": ft.colors.BLUE, "Matematik": ft.colors.GREEN, "Nesneler": ft.colors.YELLOW}
        ...
        self.parent_index = {
            "Harfleri Öğren": self.learn_letter_index, "Harfleri Çiz": self.draw_letter_index, "Harfleri Oku": self.letter_sequence_index,
            "Şekilleri Öğren": self.learn_shape_index, "Şekilleri Çiz": self.draw_shape_index,
            "Sayıları Öğren": self.learn_number_index, "Sayı İşlemleri": self.learn_math_index,
        }
        self.coded_parent_index = {}
        for k, v in self.parent_index.items(): self.coded_parent_index.update({k.lower().replace(" ",""): v})
        self.current_index = None

        self.activation_time = None

    def is_level_on(self, page):
        psr = [list(i.values()) for i in list(self.parent_index.values())]
        ps = []
        for p in psr: ps += p
            ...
            items=[
                ft.Container(
                    ft.Column([
                        ...
                        ft.Text("Merhaba! Burada Down-Up ile tanışacak, eğitimde fırsat eşitliği yolculuğuna çıkacaksınız!", height=page.height//6, style=ft.TextThemeStyle.TITLE_MEDIUM, width=float("inf"), text_align=ft.TextAlign.CENTER),
                ...
                ft.Container(
                    ft.Column([
                        ...
                        ft.Text("Menüde gördüğün bir etkinlik seç.", height=page.height//6, style=ft.TextThemeStyle.TITLE_MEDIUM, width=float("inf"), text_align=ft.TextAlign.CENTER),
                    ], alignment=ft.MainAxisAlignment.SPACE_EVENLY),
                    padding=ft.Padding(0, 10, 0, 0)
                ),
                ft.Container(
                    ft.Column([
                        ...
                        ft.Text("Ardından en efektif şekilde öğrenmeye başla!", height=page.height//6, style=ft.TextThemeStyle.TITLE_MEDIUM, width=float("inf"), text_align=ft.TextAlign.CENTER)
                    ], alignment=ft.MainAxisAlignment.SPACE_EVENLY),
                    padding=ft.Padding(0, 10, 0, 0),
                ),
            ],
    ...
    def ogren(self, page):
        ...
        col = ft.Column([
            ft.ElevatedButton(content=ft.Row([
                ft.Text(ikey), 
                ft.Row([
                    ft.Text("%"+str(int((len(self.parent_index_states[ikey][0])/len(self.parent_index[ikey]))*100))),
                    ft.Container(ft.ProgressRing(bgcolor="grey", value=max(1/100, len(self.parent_index_states[ikey][0])/len(self.parent_index[ikey]))), padding=12, height=50, width=50),
                ]),
            ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
    ...
    def level_index(self, page, index):
        ...
        page.appbar = ft.AppBar(leading=ft.Container(content=ft.IconButton(icon=ft.icons.KEYBOARD_ARROW_LEFT, icon_size=40, on_click=lambda x: page.go("/down-up")), padding=ft.Padding(4, 0, 0, 0)), title=self.page_name, center_title=True, actions=[self.page_icon], bgcolor="#EBF2F7", toolbar_height=70)

        self.current_index = index
        index = self.coded_parent_index[index]
                    ...
                    controls=[
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Pazartesi" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5),
                            ),
                        ...
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Salı" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5)
                            ),
                        ...
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Çarşamba" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5)
                            ),
                        ...
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Perşembe" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5)
                            ),
                        ...
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Cuma" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5)
                            ),
                        ...
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Cumartesi" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5)
                            ),
                        ...
                        ft.DragTarget(
                            ...
                            content=ft.Container(
                                ...
                                width=float("inf"),
                                bgcolor="#F2F6FA" if self.day != "Pazar" else "#F2F6FA",
                                border_radius=5,
                                border=ft.border.all(2, "white"),
                                padding=ft.Padding(5, 5, 5, 5)
                            ),
    ...
    def profil(self, page):
        ...
        col = ft.Column([
            ...
            height=50, width=float("inf"), bgcolor="white", border=ft.border.all(2, "white"))
            for ikey in list(self.parent_index.keys())
        ], scroll=ft.ScrollMode.ALWAYS, on_scroll=fix_color, expand=True, alignment=ft.alignment.top_center)
    ...
    def report(self, page):
        ...
        file_count = ft.Text(value="0 dosya seçildi.", style=ft.TextThemeStyle.BODY_SMALL)
    ...
    def learn_letter(self, page, letter, event=None):
        ...
        self.audio_object0 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/benimle-soyle.mp3?raw=true", autoplay=True)
        self.audio_object0.on_state_changed = play_on_end
        page.overlay.append(self.audio_object0)

        self.audio_object1 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/letters/{letter.lower()}.mp3?raw=true")
        ...
        col = ft.Column(
            controls=[
                ft.Container(ft.Text(letter.upper()+letter.lower(), style=ft.TextThemeStyle.DISPLAY_LARGE), border_radius=5, width=float("inf"), alignment=ft.alignment.top_center),
    ...
    def draw_letter(self, page, letter, event=None):
        ...
        self.audio_object = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/letters/draw/{letter.lower()}.mp3?raw=true", autoplay=True)
        ...
        col = ft.Column(
            controls=[
                ft.Container(ft.Text(letter.upper(), style=ft.TextThemeStyle.DISPLAY_LARGE), border_radius=5, width=float("inf"), alignment=ft.alignment.top_center),
                ft.Text(""),
    ...
    def letter_sequence(self, page, letters, event=None):
        ...
        self.audio_object0 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/harfleri-sirayla-seslendir.mp3?raw=true", autoplay=True)
        self.audio_object0.on_state_changed = play_on_end
        page.overlay.append(self.audio_object0)

        self.audio_objects = [ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/letters/{letter.lower()}.mp3?raw=true", on_state_changed=play_queue) for letter in letters]
        ...
        col = ft.Column(
            controls=[
                ft.Container(ft.Text("-".join(list(letters.upper())), style=ft.TextThemeStyle.DISPLAY_MEDIUM), border_radius=5, width=float("inf"), alignment=ft.alignment.top_center),
                ft.Row([replay_btn, record_btn], alignment=ft.MainAxisAlignment.SPACE_AROUND),
            ],
            alignment=ft.MainAxisAlignment.SPACE_AROUND,
        )
    ...
    def learn_shape_2d(self, page, shape_2d, event=None):
        ...
        self.audio_object0 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/2d-shapes/info/{shape_2d.lower()}.mp3?raw=true", autoplay=True)
        self.audio_object0.on_state_changed = play_on_end1
        page.overlay.append(self.audio_object0)

        self.audio_object1 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/benimle-soyle.mp3?raw=true")
        self.audio_object1.on_state_changed = play_on_end2
        page.overlay.append(self.audio_object1)

        self.audio_object2 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/2d-shapes/{shape_2d.lower()}.mp3?raw=true")
        page.overlay.append(self.audio_object2)

        webview_ring = ft.Row([ft.ProgressRing()], alignment=ft.MainAxisAlignment.CENTER, vertical_alignment=ft.CrossAxisAlignment.CENTER)
        def hide_ring(e):
    ...
    def draw_shape_2d(self, page, shape_2d, event=None):
        ...
        self.audio_object = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/2d-shapes/draw/{shape_2d.lower()}.mp3?raw=true", autoplay=True)
        page.overlay.append(self.audio_object)
        ...
        def check_shape_2d(e):
            ...
            elif o != float("inf") and float(o) >= 4: sh = ["kare", "dikdörtgen"]
            elif o == 3: sh = ["üçgen"]
            else: sh = []

            if shape_2d.lower() in [i.lower() for i in sh]: self.act_success(page)
            else: self.act_fail(page)
    ...
    def learn_shape_3d(self, page, shape_3d, event=None):
        ...
        self.audio_object0 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/3d-shapes/info/{shape_3d.lower()}.mp3?raw=true", autoplay=True)
        self.audio_object0.on_state_changed = play_on_end1
        page.overlay.append(self.audio_object0)
        ...
        self.audio_object2 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/3d-shapes/{shape_3d.lower()}.mp3?raw=true")
        page.overlay.append(self.audio_object2)
    ...
    def learn_number(self, page, number, event=None):
        ...
        self.audio_object1 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/benimle-soyle.mp3?raw=true", autoplay=True)
        self.audio_object1.on_state_changed = play_on_end
        page.overlay.append(self.audio_object1)

        self.audio_object2 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/numbers/{number.lower()}.mp3?raw=true")
        page.overlay.append(self.audio_object2)
        ...
        col = ft.Column(
            controls=[
                ft.Column([
                    ft.Container(ft.Text(number.upper(), style=ft.TextThemeStyle.DISPLAY_LARGE), border_radius=5, width=float("inf"), alignment=ft.alignment.top_center),
                    apple_grid,
    ...
    def learn_symbol(self, page, symbol, event=None):
        ...
        self.audio_object = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/symbols/{name2symbol[symbol.lower()]}.mp3?raw=true", autoplay=True)
        ...
        def check_symbol(e):
            parent_name = list(self.parent_index.keys())[[page.route in list(r.values()) for r in list(self.parent_index.values())].index(True)]
        ...
        col = ft.Column(
            controls=[
                ft.Container(ft.Text(f"{symbol.capitalize()} ({name2symbol[symbol.lower()]})", style=ft.TextThemeStyle.DISPLAY_SMALL), border_radius=5, width=float("inf"), alignment=ft.alignment.top_center),
                ft.Column([ft.Container(ft.Text(" ".join(name2example[symbol.lower()]), style=ft.TextThemeStyle.HEADLINE_MEDIUM), width=float("inf"), alignment=ft.alignment.top_center, bgcolor="#F2F6FA", padding=ft.Padding(15, 15, 15, 15), border_radius=5, border=ft.border.all(2, "white")),
                ft.Container(
                    ft.Column([
                        ft.GridView(
                            expand=False,
                        ...
                        ft.Container(ft.Text(a, style=ft.TextThemeStyle.DISPLAY_SMALL), width=float("inf"), alignment=ft.alignment.top_center)
    ...
    def math_operation(self, page, operation, event=None):
        ...
        self.audio_object0 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/math-operations/{operation}.mp3?raw=true", autoplay=True)
        self.audio_object0.on_state_changed = play_on_end
        page.overlay.append(self.audio_object0)

        self.audio_object1 = ft.Audio(release_mode=ft.audio.ReleaseMode.STOP, src=f"https://github.com/durugezekli/project-down_up/blob/audio-assets/gorsel-olarak-ifade-et.mp3?raw=true")
        page.overlay.append(self.audio_object1)

        self.result_label = ft.Text("0")

        def check_operation(e):
            if int(float(self.result_label.value)) == answer: self.act_success(page)
            else: self.act_fail(page)
        ...
        col = ft.Column(
            controls=[
                ft.Column([
                    ft.Container(ft.Text(" ".join(list(operation)) + " = " + str(int(eval(operation))), style=ft.TextThemeStyle.DISPLAY_SMALL), border_radius=5, width=float("inf"), alignment=ft.alignment.top_center),
                    ft.Row([
                        ft.Draggable(content=ft.Container(ft.Image("apple.png", fit=ft.ImageFit.FIT_WIDTH), height=75, width=75, bgcolor="#F2F6FA", padding=ft.Padding(10, 10, 10, 10), border_radius=5, border=ft.border.all(1, "black"))), 
                        ft.Draggable(content=ft.Container(ft.Icon(ft.icons.ADD), height=75, width=75, bgcolor="#F2F6FA", padding=ft.Padding(10, 10, 10, 10), border_radius=32, border=ft.border.all(1, "black"))), 
                        ft.Draggable(content=ft.Container(ft.Icon(ft.icons.REMOVE), height=75, width=75, bgcolor="#F2F6FA", padding=ft.Padding(10, 10, 10, 10), border_radius=100, border=ft.border.all(1, "black"))),
                    ], alignment=ft.MainAxisAlignment.SPACE_AROUND),
                ]),
                ft.Row([replay_btn, check_btn], alignment=ft.MainAxisAlignment.SPACE_AROUND),
            ],
    ...
    def act_success(self, page):
        parent_name = list(self.parent_index.keys())[[page.route in list(r.values()) for r in list(self.parent_index.values())].index(True)]
        if not self.page_name.value in self.parent_index_states[parent_name][0]: self.parent_index_states[parent_name][0].append(self.page_name.value)
        page.client_storage.set("parent_states_index_dict", self.parent_index_states)
    ...
    def main(self, page: ft.Page):
        ...
        if page.client_storage.contains_key("parent_index_states_dict"):
            ...
            self.parent_index_states = {
                "Harfleri Öğren": [[], {}], "Harfleri Çiz": [[], {}], "Harfleri Oku": [[], {}],
                "Şekilleri Öğren": [[], {}], "Şekilleri Çiz": [[], {}],
                "Sayıları Öğren": [[], {}], "Sayı İşlemleri": [[], {}],
            }

        self.login_time = datetime.now()
        self.day = {"Monday": "Pazartesi", "Tuesday": "Salı", "Wednesday": "Çarşamba", "Thursday": "Perşembe", "Friday": "Cuma", "Saturday": "Cumartesi", "Sunday": "Pazar"}[self.login_time.strftime("%A")]
        
        self.log_days_keys = {}
        for i in range(0, 8):
            od = self.login_time-timedelta(days=i)
            self.log_days_keys.update({od.strftime("%d-%m-%Y"): od.strftime("%A")})

        print(self.log_days_keys)
